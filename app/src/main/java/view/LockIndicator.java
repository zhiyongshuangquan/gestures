...
public class LockIndicator extends View {
    ...
    public LockIndicator(Context paramContext, AttributeSet paramAttributeSet) {
        ...
        if (patternPressed != null) {
            patternWidth = patternPressed.getIntrinsicWidth() - 20;
            patternHeight = patternPressed.getIntrinsicHeight() - 20;
            this.f = (patternWidth / 10);
            this.g = (patternHeight / 10);
            patternPressed.setBounds(10, 10, patternWidth - 10, patternHeight - 10);
            patternNoraml.setBounds(10, 10, patternWidth - 10, patternHeight - 10);
        }
    }
